...
import aboutTeamImg from "../../assets/about-team-v4.png";
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-full">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <p className="text-white/90 text-sm italic font-light leading-snug">
                  "TÀGG –{" "}
                  <span className="text-[#7EDED6]">Là où vos idées prennent leur envol !</span>"
                </p>
              </div>
            </div>
            ...
            >
              <img src={logoImg} alt="TÀGG" className="h-12 w-auto mb-1" />
              {/* <p className="text-xs text-gray-400 text-center mt-1">Depuis 2020</p> */}
            </motion.div>
          ...
          <div>
            ...
            >
              ...
              >
                ...
                >
                  votre partenaire TÀGG.
                </span>
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-4">
                TÀGG Group est une entreprise informatique sénégalaise spécialisée dans la création
                de solutions technologiques sur mesure. Nous transformons vos idées les plus ambitieuses
                en produits concrets, performants et évolutifs.
              </p>
              <p className="text-gray-500 leading-relaxed mb-10">
                ...
                l'intégralité du spectre technologique pour faire décoller votre projet.
              </p>
            </motion.div>
